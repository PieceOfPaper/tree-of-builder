module.exports = function(app, serverSetting, tableData, scriptData, imagePath){
  ...
  var mysqls = require('sync-mysql');
    ...
    function monsterDetailPage(index, request, response) {
        ...
        var comment_results = connection.query('SELECT * FROM comment WHERE state=0 AND page="Quest" AND page_arg1="'+''+'" AND page_arg2='+request.query.id+' ORDER BY time DESC LIMIT 100;');
