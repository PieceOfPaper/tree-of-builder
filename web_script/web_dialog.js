module.exports = function(app, serverSetting, tableData, scriptData, imagePath){
  ...
  var dbLayout = require('../my_modules/DBLayoutModule');
    ...
    function dialogDetailPage(index, request, response) {
      ...
      var comment_results = connection.query('SELECT * FROM comment WHERE state=0 AND page="Dialog" AND page_arg1="'+''+'" AND page_arg2='+request.query.id+' ORDER BY time DESC LIMIT 100;');
